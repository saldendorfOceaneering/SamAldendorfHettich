...
def run_updating_server(host, port):
    """Run updating server."""
    # ----------------------------------------------------------------------- #
...
def ModbusServer(host, port):
    #run_updating_server( host, port )
    print(" ModbusServer: ", host, port )
    
    


if __name__ == "__main__":
    run_updating_server("localhost", "5020" )
